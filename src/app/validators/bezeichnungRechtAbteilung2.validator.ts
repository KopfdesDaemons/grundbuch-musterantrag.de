...
export function BezeichnungRechtAbteilung2Validator(): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
        ...
        return containsInvalidOption ? {
            nichtAbteilung2: {
                message: 'Diese Formular ist nicht für diese Recht geeignet, da es nicht in der Abteilung II eingetragen wird. Bei Löschungen von Rechten in Abteilung III bedarf es einer Unterschriftsbeglaubigung.'
            }
        } : null;
    };
}