...
export function RechtIstLoeschbarValidator(): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
        ...
        return containsInvalidOption
            ? {
                nichtAbteilung2: {
                    message: 'Eintragungen vom Vollstreckungsgericht werden durch ein Ersuchen des Vollstreckungsgerichts an das Grundbuchamt gelöscht. Dies geschieht automatisch nach Abschluss des dortigen Verfahrens.'
                }
            }
            : null;
    };
