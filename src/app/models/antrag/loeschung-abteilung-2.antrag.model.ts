...
export class AntragLoesschungAbt2 implements Antrag {
  ...
  hinweise?: string[] | undefined = [
    'Stellen Sie sicher, dass die Löschung des Rechts überhaupt möglich ist. Ein Wohnungsrecht kann z.B. ohne Weiteres mit einem Sterbenachweis oder einer Löschungsbewilligung gelöscht werden. Ein Nießbrauchrecht ohne Löschungsklausel kann erst nach Ablauf eines Jahres mit einem Sterbenachweis gelöscht werden, davor sind Löschungsbewilligungen der Erben erforderlich. Bei Löschung von Vormerkungen ist der Inhalt der Bewilligung maßgebend.',
    'Fügen Sie die Löschungsbewilligung in öffentlich beglaubigter Form oder den Sterbenachweis als beglaubigte Abschrift bei.',
    'Für jedes zu löschende Recht erhebt das Grundbuchamt eine Gebühr in Höhe von 25,00 €.',
    'Dem Antrag ist zwingend eine beglaubigte Abschrift des Sterbenachweises oder eine öffentlich beglaubigte Löschungsbewilligung beizufügen. Eine einfache Kopie ist nicht ausreichend.'
  ];
