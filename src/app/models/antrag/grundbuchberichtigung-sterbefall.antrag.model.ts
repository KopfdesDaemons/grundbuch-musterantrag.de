...
export class AntragGrundbuchberichtigungSterbefall implements Antrag {
  ...
  hinweise?: string[] | undefined = [
    'Die Grundbuchberichtigung ist innerhalb von 2 Jahren ab dem Sterbefall gebührenfrei. Bei einer Berichtigung nach 2 Jahren entsteht die Gebühr für eine Eigentumsumschreibung.',
