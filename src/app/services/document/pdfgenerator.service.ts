        ...
        .subscribe({
          next: res => {
            ...
            if (res.type === HttpEventType.UploadProgress) {
              ...
              if (uploadProzent === 100) {
                this.statusmeldung =
                  'Die .docx Datei wurde zur Konvertierung an den Server gesendet. Der Server muss die Datei noch in eine .pdf Datei konvertieren.';
              }
            }
          ...
          error: err => {
            ...
            if (err.status >= 500 && err.status < 600) {
              // Server-Fehler
              this.statusmeldung =
                'Es gab einen Serverfehler. Die .pdf Datei konnte nicht generiert werden. Sie können die .docx Datei herunterladen.';
            } else {
              this.statusmeldung =
                'Es gab einen Netzwerkfehler. Die .pdf Datei konnte nicht generiert werden. Sie können die .docx Datei herunterladen.';
            }
            throw err;
          }
        });
